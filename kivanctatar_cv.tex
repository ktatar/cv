...
%	\cvitem{Canada}{Permanent Resident, since 2020-07-07}
	...
	\cvitem{C13}{Obaid M., \textcolor{magenta}{Tatar K.}, Wiberg M., Said A., Rost M., Weilenmann A., Johal W., Eyssel F. (2022). \textit{Social Drones for Health and Well-being}. In Adjunct Proceedings of the 2022 Nordic Human-Computer Interaction Conference.}
    ...
    \cvitem{C11}{Diapoulis G., Zannos I., \textcolor{magenta}{Tatar, K.}, Dahlstedt P. (2022). Bottom-up live coding: Analysis of continuous interactions towards predicting programming behaviours. Accepted to New Interfaces for Music Expression Conference 2022.}
	...
	\cvitem{}{\begin{center}\small\textcolor{magenta}{\textcolor{magenta}{Arxiv Papers}}\end{center}}
	...
	\cvitem{2021-01-28}{\textbf{Coding the Latent No.1}, live coding performance using Deep Learning based audio generation with 3D audio and realtime visuals, as a part of \href{https://zkm.de/en/event/2022/01/on-the-fly-live-coding-hacklab}{Live Coding Hack Lab} of \href{https://onthefly.space}{on-the-fly}, at the Kubus, \textcolor{magenta}{\href{https://zkm.de/en/person/kivanc-tatar}{Center for New Media (ZKM)} Karlsruhe, Germany}}
	...
	\cvitem{2022-09-13}{\textbf{Talk.} \href{https://www.aau.dk/ai-and-creativity-e36349}{\textit{A Different Take on AI: Design Processes and Interaction in  Machine Learning and Artificial Intelligence for Music and Arts}} at Aalborg University in \textcolor{magenta}{Denmark}.}
	...
	\cvitem{2022-06}{\textbf{Workshop}.  \textit{Sound Design using Deep Learning}. HCI Summer School 2022, organized by SIGCHI, Chalmers University of Technology, and Politechnika  Łódźka, hosted in \textcolor{magenta}{Łódź, Poland}}
    ...
    \cvitem{WASPHS-1}{\href{https://wasp-hs.org/people/kivanc-tatar}{WASP-HS - Interactive AI – Ethics and Aesthetics of Human-Machine Interaction in Art, Music, and Games}; the grant is acquired by Chalmers University of Technology, and written by Prof. Palle Dahlstedt, and kindly offered to K{\i}van\c{c} Tatar (PI) as a starting package for Assistant Professorship position. 12 million SEK = 1.2 million EUR approx. }
	\cvitem{CHAIR X+AI}{\href{https://www.chalmers.se/en/centres/chair/opportunities/Pages/Call-for-projects-CHAIR-X---AI.aspx}{AI + Social Drones: Towards Autonomous and Adaptive Social Drones.} Mohammad Obaid (PI), K{\i}van\c{c} Tatar (co-PI), Mikael Wiberg (co-PI).  400 000 SEK}
	...
	\section{Employment}
	\cvitem{ongoing 2021-10}{\textbf{Assistant Professor} in Interactive AI - Ethics and aesthetics of human-machine interaction in art, music, and games; Interaction Design Unit, Computer Science and Engineering, Chalmers University of Technology; Gothenburg, Sweden}
	...
	\cvitem{2017}{\textbf{OP-1}, Beta test: Opposition is overrated, by \c{C}EK\.{I}\c{C}, Independent}
	\cvitem{2016}{\textbf{Electronics}, Self Distruption, by K{\i}van\c{c} Tatar, Independent}
	\cvitem{2016}{\textbf{Trumpet\&Electronics}, Live at Red Gate, by Organic Strategies, Independent}
	\cvitem{2014}{\textbf{Composer}, Early Works (2012-2014), by K{\i}van\c{c} Tatar, Independent}
	\cvitem{2012}{\textbf{Composer}, Dialectic, by K{\i}van\c{c} Tatar, Independent}
	\cvitem{2011}{\textbf{Composer}, Huzur, by K{\i}van\c{c} Tatar, Independent}
...
% 	\cvitem{2019}{\href{https://www.hf.uio.no/ritmo/english/projects/all/nordicsmc/events/conferences/2019/winter-school/projects/group-c/index.html}{Participant at the first NordicSMC Winter School by University of Oslo}}
	
% 	\cvitem{2019}{\textbf{Certificate:}\href{https://www.futurelearn.com/certificates/d5y6jp1}{ Music Moves by University of Oslo} on Future Learn}
	
% 	\cvitem{2018}{\href{https://www.kadenze.com/certificates/verified/SOPC265Z}{\textbf{Certificate:}} \href{https://www.kadenze.com/courses/creative-applications-of-deep-learning-with-tensorflow-iv/info}{Creative Applications of Deep Learning with TensorFlow, Kadenze}}
	
% 	\cvitem{2017}{\href{https://www.kadenze.com/certificates/verified/T3SPFG2I}{\textbf{Certificate:}}\href{https://www.kadenze.com/courses/programming-max-structuring-interactive-software-for-digital-arts-i/info}{ Programming Max: Structuring Interactive Software for Digital Arts, Kadenze} }

% 	\cvitem{2013-2011}{Jazz Compositon \& Arrangement, \"{U}mit Ero\u{g}lu}
	
% 	\cvitem{2012-2011}{Jazz Trumpet, \.{I}mer Demirer}
	
% 	\cvitem{2012}{Music Theory, Nejat Ba\c{s}e\u{g}mezler Music and Fine Arts Department, METU, Ankara}
	
% 	\cvitem{2013-2008}{Jazz Theory \& Improvisation, \"{U}mit Ero\u{g}lu}
	
% 	\cvitem{2014-2007}{Trumpet, Adnan Y{\i}ld{\i}r{\i}m, Methods: Arban, Colin, Clarke, Clodemir, Music and Fine Arts Department, METU, Ankara}
	
% 	\cvitem{2006}{Music Appreciation, Nejat Ba\c{s}e\u{g}mezler Music and Fine Arts Department, METU, Ankara}
	
% 	\cvitem{2003-2006}{Jazz Guitar \& Theory, Onur M\"{u}layim}
	
	%\section{Test Scores}
	%\cvitem{2013}{ALES (National Graduate Studies Enterance Exam in Turkey): Ranked 80th on Social Sciences and Humanities track, out of 80 thousand exam takers.}
	
	%\cvitem{2006}{ÖSS (National University Enterance Exam in Turkey): Ranked top \%1 within 1.7 million exam takers with the rank 1006 on the Science and Mathematics track.}
